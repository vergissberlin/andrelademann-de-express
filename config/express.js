...
module.exports = function (app, config) {
	...
	app.use(compress());
	app.use(express.static(config.root + '/public', {maxAge: oneDay * 60}));
	app.use(express.static('img', {maxAge: oneDay * 45}));
	app.use(express.static('css', {maxAge: oneDay * 30}));
	app.use(express.static('fnt', {maxAge: oneDay * 90}));
	app.use(express.static('js', {maxAge: oneDay * 30}));
